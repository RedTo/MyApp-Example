...
class MyWidgetCreator {
  ...
  static Widget getDrawer(BuildContext context) {
    return Drawer(
      child: ListView(
        children: <Widget>[
          UserAccountsDrawerHeader( //special drawer header
  ...
  static Widget buildGenericSpinner([String text = "Refreshing..."]) {
    return ProgressHUD(
      backgroundColor: Colors.black26, //the color around the progress hud
      color: Colors.white, //the font color inside the progress hud
      containerColor: Colors.blue, //the color of the "popup"
      borderRadius: 5.0,
      text: text,
    );
  }
